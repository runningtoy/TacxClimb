...
#define mqtt_width 64
#define mqtt_height 64
...
void ShowOnOledLarge(char *Line1, char *Line2, char *Line3, uint16_t Pause=1,uint16_t headerColor=BLACK,ICON ico=ICON::ICO_NONE) {
  ...
  switch(ico){
    ...
    case ICO_BLE:
    {
      M5.Lcd.drawXBitmap(M5.Lcd.width()/2-BLE64_width/2,M5.Lcd.height()/2, BLE64_bits, BLE64_width, BLE64_height, TFT_BLUE, TFT_WHITE);
      break;
    }
    case ICO_LIFTER:
    {
